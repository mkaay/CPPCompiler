...
public class TypeException extends RuntimeException {
    ...
    public static TypeException returnType(Stm stm, TypeCode actualType, Environment env) {
    ...
    public static TypeException expressionCondition(Exp exp, TypeCode actualType, Environment env) {
    ...
    public static TypeException expressionType(Exp exp, TypeCode actualType, TypeCode expectedType, Environment env) {
        return new TypeException(String.format("Expression '%s' has type '%s' expected '%s', in function '%s'",
                PrettyPrinter.print(exp), actualType, expectedType, env.getFunctionName()));
    }

    public static TypeException expressionNumber(Exp exp, TypeCode actualType, Environment env) {
    ...
    public static TypeException argumentCount(Exp exp, String name, int actualCount, int expectedCount, Environment env) {
    ...
    public static TypeException variableUnknown(String name, Environment env) {
        return new TypeException(String.format("Variable '%s' not declared in this scope", name));
    }

    public static TypeException variableExists(String name, Environment env) {
        return new TypeException(String.format("Variable '%s' is already declared in this scope", name));
    }

    public static TypeException functionUnknown(String name, Environment env) {
        return new TypeException(String.format("Function '%s' does not exist", name));
    }

    public static TypeException functionExists(String name, Environment env) {
